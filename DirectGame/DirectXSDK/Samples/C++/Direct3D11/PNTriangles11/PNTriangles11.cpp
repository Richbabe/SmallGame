                                     ...
                                     void* pUserContext )
{
    ...
    // PNTriangles HS
    V_RETURN( CompileShaderFromFile( L"PNTriangles11.hlsl", "HS_PNTriangles", "hs_5_0", &pBlob, NULL ) ); 
    ...
    V_RETURN( CompileShaderFromFile( L"PNTriangles11.hlsl", "HS_PNTriangles", "hs_5_0", &pBlob, ShaderMacros ) ); 
