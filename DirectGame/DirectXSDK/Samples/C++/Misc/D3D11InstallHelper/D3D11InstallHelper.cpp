...
//--------------------------------------------------------------------------------------
STDAPI DoUpdateForDirect3D11( BOOL bQuiet, D3D11UPDATEPROGRESSCB pfnProgress,
...
{
    UINT result;
    HRESULT hr = DoUpdateForDirect3D11( bQuiet, NULL, NULL, &result );
    if ( SUCCEEDED( hr ) )
    {
